    ...
    public static int countOfPrimitiveCalls(Statement s) {
        ...
        switch (s.kind()) {
            ...
            case IF: {
                ...
                Statement.Condition c = s.disassembleIf(st);
                count += countOfPrimitiveCalls(st);
                s.assembleIf(c, st);
            ...
            case IF_ELSE: {
                ...
                // TODO - fill in case
                Statement stIf = s.newInstance();
                Statement stElse = s.newInstance();

                Statement.Condition c = s.disassembleIfElse(stIf, stElse);
                count += countOfPrimitiveCalls(stIf);
                count += countOfPrimitiveCalls(stElse);
                s.assembleIfElse(c, stIf, stElse);
                break;
            }
            case WHILE: {
                /*
                ...
                Statement.Condition c = s.disassembleWhile(st);
                count += countOfPrimitiveCalls(st);
                s.assembleWhile(c, st);

...
public abstract class ProgramTest {
    ...
    private static final String FILE_NAME_1 = "test/program1.bl",
            ...
            FILE_NAME_4 = "test/program4.bl", FILE_NAME_5 = "test/program4.bl";
    ...
    /**
     * Test of parse on syntactically invalid input where the name of an
     * instruction is a primitive.
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorPrimitiveInstruction() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorDuplicateInstruction() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
    ...
    /**
     * Test of parse on syntactically valid input with empty body.
     */
    @Test(expected = RuntimeException.class)

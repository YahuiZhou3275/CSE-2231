...
public abstract class StatementTest {
    ...
    /**
     * The name of a file containing an IF BL statement.
     */
    private static final String FILE_NAME_2 = "data/new-statement-2.bl";

    /**
     * The name of a file containing an IF_ELSE BL statement.
     */
    private static final String FILE_NAME_3 = "data/new-statement-3.bl";

    /**
     * The name of a file containing a CALL BL statement.
     */
    private static final String FILE_NAME_4 = "data/new-statement-4.bl";

    /**
     * The name of a file containing a nested loops BL statement.
     */
    private static final String FILE_NAME_5 = "data/new-statement-5.bl";
    ...
    // Tests for a simple IF BL statement below.
    ...
    public final void testKindIf() {
        ...
        Statement sTest = sourceTest.removeFromBlock(0);
        Statement sRef = sourceRef.removeFromBlock(0);
        Kind kRef = sRef.kind();
    ...
    // Tests for a simple IF_ELSE BL statement below.
     ...
     */
    @Test
    public final void testAssembleIfElseFile3() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testDisassembleIfElseFile3() {
        /*
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_3);
    ...
    // Tests for a simple CALL BL statement.
     ...
     */
    @Test
    public final void testDisassembleCallFile4() {
        /*
         * Setup
         */
    ...
    // Tests for a nested loop BL statement below.

    /**
     * Test assembleIf with a nested while loop.
     */
    @Test
    public final void testAssembleIfFile5() {
        /*
         * Setup
         */
    ...
    /**
     * Test disassembleIf with a nested while loop.
     */
    @Test
    public final void testDisassembleIfFile5() {
        /*
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_5);

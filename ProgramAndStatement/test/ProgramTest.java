...
public abstract class ProgramTest {
     ...
     */
    private static final String FILE_NAME_2 = "data/new-program-2.bl";

    /**
     * The name of a file containing a BL program with an empty context.
     */
    private static final String FILE_NAME_3 = "data/new-program-3.bl";

    /**
     * The name of a file containing a BL program with an empty body.
     */
    private static final String FILE_NAME_4 = "data/new-program-4.bl";
    ...
    // Tests for a program with an empty context below.

    /**
     * Test name (empty context).
     */
    @Test
    ...
    /**
     * Test swapContext (empty context).
     */
    @Test
    ...
    // Tests for a program with an empty body below.

    /**
     * Test name (empty body).
     */
    @Test

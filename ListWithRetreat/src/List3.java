...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        newElement.next = firstRight;
        lastLeft.next = newElement;

        newElement.previous = firstRight.previous;
        firstRight.previous = newElement;
    ...
    public final T removeRightFront() {
        ...
        Node newRightFront = removedNode.next;

        newRightFront.previous = removedNode.previous;
        this.lastLeft.next = removedNode.next;

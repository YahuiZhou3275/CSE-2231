...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    private void createNewRep(int hashTableSize) {
        ...
        for (int i = 0; i < hashTableSize; i++) {
            ...
            Map<K, V> map = new Map1L<>();
            this.hashTable[i] = map;
    ...
    public final void add(K key, V value) {
        ...
        int location = mod(number, this.hashTable.length);
    ...
    public final Pair<K, V> remove(K key) {
        ...
        int number = key.hashCode();
        int location = mod(number, this.hashTable.length);
        Pair<K, V> removed = this.hashTable[location].remove(key);
    ...
    public final Pair<K, V> removeAny() {
        ...
        int count = 0;
        while (this.hashTable[count].size() == 0) {
            count++;
        }
        Pair<K, V> removed = this.hashTable[count].removeAny();
    ...
    public final V value(K key) {
        ...
        int number = key.hashCode();
        int location = mod(number, this.hashTable.length);
        V valueToKey = this.hashTable[location].value(key);
    ...
    public final boolean hasKey(K key) {
        ...
        int number = key.hashCode();
        int location = mod(number, this.hashTable.length);
        boolean hasKey = this.hashTable[location].hasKey(key);

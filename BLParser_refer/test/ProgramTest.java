...
public abstract class ProgramTest {
    ...
    private static final String FILE_NAME_1 = "test/program1.bl",
            ...
            FILE_NAME_5 = "test/programInstructionPrimitive",
            FILE_NAME_6 = "test/programNoIs", FILE_NAME_7 = "test/programNoEnd",
            FILE_NAME_8 = "test/programWrongInstrName",
            FILE_NAME_9 = "test/programLowercase.bl",
    ...
    /**
     * Test of parse on syntactically invalid input (lowercase PROGRAM).
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorExampleLowercaseProgram() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
